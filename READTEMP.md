...
CUDA_VISIBLE_DEVICES=0 python tools/relation_train_net.py --task sgdet --save-best --config-file "configs/PSG/react_yolov8m.yaml" MODEL.ROI_RELATION_HEAD.PREDICTOR REACTPredictor SOLVER.IMS_PER_BATCH 4 TEST.IMS_PER_BATCH 1 DTYPE "float16" SOLVER.MAX_EPOCH 1 OUTPUT_DIR ./checkpoints/react-precls-exmp
